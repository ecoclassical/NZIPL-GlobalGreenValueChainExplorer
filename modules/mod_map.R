  ...
  tagList(
    div(class = "outer",
        ...
        absolutePanel(
          ...
          top = 70, left = 10, width = 360, draggable = TRUE,
          h4("Controls"),
          ...
          hr(),
          h5("Top 10 countries"),
          plotOutput(ns("top10"), height = 160),   # smaller
          h5("Export trend"),
          plotOutput(ns("trend"), height = 160)    # smaller
        ),
        absolutePanel(
  ...
  moduleServer(id, function(input, output, session) {
    ...
    output$top10 <- renderPlot({
      ...
      df |>
        ...
        ggplot2::ggplot(ggplot2::aes(reorder(country_name, total), value, fill = .data[[key]])) +
